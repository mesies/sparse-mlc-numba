...
class MLC_LinearRegression:
    def __init__(self, learning_rate=0.0001, iterations=1000, debug=False, verbose=False, batch_size=20):
    ...
    def fit(self, X, y):
        ...
        self.w = self.stochastic_gradient_descent(X, y, epochs=self.iterations, tolerance=1e-3, batch_size=self.batch_size)
        return self.w
