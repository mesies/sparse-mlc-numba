...
N = np.array([250, 500, 750, 1000, 1250, 1500])
scores = list()
scores_sgd = list()
times = list()
times_sgd = list()
...
for n in N:
    ...
    mlc1 = MlcLinReg(learning_rate=0.6, iterations=iterations, batch_size=n)
...
print scores
print times
plt.plot(N, scores, label="MLC-SGD Mini-Batch " + "batch size " + str(batch_size) + " Score")
